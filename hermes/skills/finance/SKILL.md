...
**Slash commands owned by `@sova_finance_bot`: `/finance_app`, `/balance`, `/sync`**
For ALL of these — with or without `@sova_finance_bot` suffix — **stay completely silent**. Do not respond, do not say "Unknown command". The finance bot handles them directly.
